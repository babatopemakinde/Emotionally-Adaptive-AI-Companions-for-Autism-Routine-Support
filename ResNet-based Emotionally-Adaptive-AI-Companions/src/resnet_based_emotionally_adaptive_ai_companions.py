# -*- coding: utf-8 -*-
"""ResNet-based Emotionally-Adaptive-AI-Companions.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UZQT0qn_QSQTlKBIUjh7_Cb4HCuBJ_-u
"""
...
def load_and_preprocess_data(zip_path, base_dir):
    ...
    # Updated for ResNet preprocessing
...
class MultimodalEmotionSystem:
    def __init__(self, num_classes=6, class_indices=None, base_dir=None):
        ...
        self.img_model = self._build_resnet()

    def _build_resnet(self):
        """Updated: Uses ResNet50 as the facial feature extractor."""
        # Note: Keras applications provides ResNet50 as the closest robust equivalent to ResNet18
    ...
    def generate_grad_cam(self, img_array, res=224):
        """Explainability: Generates and saves Grad-CAM visualizations for ResNet."""
        try:
            base_model = self.img_model.layers[0]
            # ResNet50 last conv layer is typically 'conv5_block3_out'
...
def launch_app(system, engine, base_dir):
    def process_multimodal(image, audio, routine, time_of_day, location, feedback):
        try:
            ...
            # 1. Facial Analysis (70% weight) - Updated for ResNet preprocessing
            img_input = cv2.resize(image, (224, 224))
            img_prep = tf.keras.applications.resnet50.preprocess_input(np.expand_dims(img_input.astype(np.float32), 0))
